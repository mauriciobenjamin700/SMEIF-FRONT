                    ...
                    <td>
                      ...
                      {activeDropDown === index && (
                        <div className="dropdown-menu">
                          <Button
                            text="Registrar as notas do 1º Semestre"
                            onFunction={() => functions[0]("registrando_notas/",{state: [info, 1]})}
                          />
                          <Button
                            text="Registrar as notas do 2º Semestre"
                            onFunction={() => functions[0]("registrando_notas/",{state: [info, 2]})}
                          />
